    ...
    <div className="w-full max-w-md p-8 space-y-8 bg-brand-surface rounded-2xl shadow-lg border border-brand-border">
        ...
        <div className="space-y-3 rounded-md">
             ...
             <div>
                ...
                autoComplete="email"
                required
                className="relative block w-full px-3 py-3 bg-gray-700 text-brand-text-primary placeholder-brand-text-muted border border-brand-border appearance-none focus:z-10 focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary sm:text-sm"
                placeholder="Email"
                value={email}
